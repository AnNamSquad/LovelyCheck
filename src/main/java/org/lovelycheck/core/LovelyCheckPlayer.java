...
public class LovelyCheckPlayer {
    ...
    private volatile String bedrockSource = null;
    private final Queue<Runnable> pendingActions = new ConcurrentLinkedQueue<>();

    public LovelyCheckPlayer(UUID uuid) {
        this.uuid = uuid;
    }
    ...
    public void setBedrockDetected(boolean bedrockDetected) {
        ...
        if (!bedrockDetected) {
            this.bedrockSource = null;
        }
    }

    public void markBedrockDetected(String source) {
        this.bedrockDetected = true;
        this.bedrockSource = source != null && !source.isBlank() ? source : null;
    }

    public String getBedrockSource() {
    ...
    public boolean equals(Object o) {
        ...
        LovelyCheckPlayer that = (LovelyCheckPlayer) o;
