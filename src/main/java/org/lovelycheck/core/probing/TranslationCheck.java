...
public final class TranslationCheck {
    ...
    public TranslationCheck(String id, String name, String translationKey,
        ...
        this(id, name, translationKey, bypassProtection, actions, "translate");
    }

    public TranslationCheck(String id, String name, String translationKey,
                            boolean bypassProtection, List<Action> actions, String mode) {
        this.id = id;
        this.name = name;
        this.translationKey = translationKey;
        this.bypassProtection = bypassProtection;
        this.actions = actions;
        this.mode = mode != null ? mode : "translate";
    }
