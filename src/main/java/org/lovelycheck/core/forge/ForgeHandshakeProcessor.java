...
public final class ForgeHandshakeProcessor {
     ...
     */
    public static ForgeHandshakeResult processClientType(LovelyCheckPlayer player, ForgeClientType clientType) {
     ...
     * @return the result with any triggered actions
     */
    public static ForgeHandshakeResult processMods(LovelyCheckPlayer player, List<ForgeModInfo> mods) {
